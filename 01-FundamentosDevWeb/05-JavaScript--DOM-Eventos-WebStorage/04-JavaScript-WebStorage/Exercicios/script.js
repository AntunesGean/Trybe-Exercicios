...
btnPqn.addEventListener("click", function() {
  for (let i in document.getElementsByClassName("text"))
  document.getElementsByClassName("text")[i].style.fontSize = "12px";
});
...
btnGrnd.addEventListener("click", function() {
  for (let i in document.getElementsByClassName("text"))
  document.getElementsByClassName("text")[i].style.fontSize = "20px";
});
...
btnPqnH.addEventListener("click", function() {
  for (let i in document.getElementsByClassName("text"))
  document.getElementsByClassName("text")[i].style.lineHeight = "80%";
});

btnNrmH.addEventListener("click", function() {
  for (let i in document.getElementsByClassName("text"))
  document.getElementsByClassName("text")[i].style.lineHeight = "normal";
});

btnGrnH.addEventListener("click", function() {
  for (let i in document.getElementsByClassName("text"))
  document.getElementsByClassName("text")[i].style.lineHeight = "200%";
});
...
btnFmlyA.addEventListener("click", function() {
  for (let i in document.getElementsByClassName("text"))
  document.getElementsByClassName("text")[i].style.fontFamily = "Arial";
});

btnFmlyB.addEventListener("click", function() {
  for (let i in document.getElementsByClassName("text"))
  document.getElementsByClassName("text")[i].style.fontFamily = "Times New Roman";
});

btnGmlyC.addEventListener("click", function() {
  for (let i in document.getElementsByClassName("text"))
  document.getElementsByClassName("text")[i].style.fontFamily = "Open Sans";
});